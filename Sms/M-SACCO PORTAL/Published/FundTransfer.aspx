<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="FundTransfer.aspx.cs" Inherits="HIMS.FundTransfer" %>
...
<div class="style1">
<h6 class="style2" style="text-transform:uppercase;"> <b> FUND TRANSFER </b> </h6>
</div>
...
<%
    using (SqlConnection mConn = new SqlConnection(CommonUtilities.ConnectionString))
    {
        ...
        //Shares Capital
        string SQL = "SELECT COUNT([Entry No]) AS Num FROM [Mobile Withdrawals] WHERE [Corporate No]=" + "'" + CorporateNo + "'";
        string SQL_2 = "";
