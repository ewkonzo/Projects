...
namespace HIMS
{
    public partial class MsaccoLoans : System.Web.UI.Page
    {
        ...
        protected void Search_Click(object sender, EventArgs e)
        {
            ...
            string CurrentPage = "MsaccoLoans.aspx?action=Loan&Show=False&Search_Pin_No=" + Search_Pin_No;
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string CurrentPage = "MsaccoLoans.aspx?action=Loan&Show=False";
            Response.Redirect(CurrentPage, false);
            Context.ApplicationInstance.CompleteRequest();
        }
    }
