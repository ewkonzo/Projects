...
namespace HIMS
{
    public partial class smstopupbulknew : System.Web.UI.Page
    {
        ...
        {            
            ...
            else
            {
                using (SqlConnection con = new SqlConnection(CommonUtilities.ConnectionString))
                {
                    string  sql ="INSERT INTO [Sacco].[dbo].[Sacco Bulksms Topup]([Sacco],[SmsCount],[Comments],[UserID])VALUES(@Sacco,@SmsCount,@Comments,@UserID)";
                    ...
                    Message("Bulk SMS topup Succesfully");

                    string CurrentPage = "";
                    CurrentPage = "smstopupbulk.aspx?action=bulksmstopup&Show=False";
