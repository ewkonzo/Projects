...
namespace Msacco
{
    ...
    public class Mobile : WebService
    {
        ...
        private Msacco.MSACCO Msacco = new Msacco.MSACCO();
        ...
        [WebMethod]
        public Results WithRequest(string phone, string Traceid, string AccountNo, Decimal Amount,transtype transtype)
        {
            try
            {
                phone = phone.Replace("+", "");
                this.results.ResultsData = (object)this.Msacco.InsertToBuffer(AccountNo, Amount, Traceid, phone,(int)transtype);
            }
            catch (Exception ex)
            {
                CUtilities.LogEntryOnFile(ex.Message);
        ...
        public List<Accounts> Getaccount(string Phone)
        {
            ...
            try
            {
                ...
                foreach (string str2 in str1.Split(separator1, (StringSplitOptions)num1))
                {
                    ...
                    a.Account_No = strArray[0];
                    a.Account_Name = strArray[1];
                    a.Staff_No = strArray[2];
                    a.Withdrawal_Allowed =strArray[3] =="Yes";
                    a.Deposit_Allowed = strArray[4] == "Yes";
                    accountsList.Add(a);
                }
            }
            catch (Exception ex)
        ...
        public List<Applications> NewRegistrations()
        {
            ...
            try
            {
                ...
                foreach (string clientRequest in str.Split(separator, (StringSplitOptions)num))
                {
                    ...
                    string[] strArray = clientRequest.Split(new char[1]{'~'}, StringSplitOptions.None);
                    applicationsList.Add(new Applications()
                    {
                        Telephone = strArray[0],
                        Applicant_Name = strArray[1]
                    });
                }
            }
            catch (Exception ex)
