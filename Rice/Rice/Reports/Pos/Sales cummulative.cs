...
{
    public partial class Sales_cumm : DevExpress.XtraReports.UI.XtraReport
    {
    ...
    public Sales_cumm()
        ...
        {             
            ...
            xrLabel5.Text =rice.formatfilter( filter);

            IEnumerable<Items_Services_List> quiry = from c in new RiceEntities(rice.ConnectionString()).Items_Services_List where (c.Reversed == false || c.Reversed == null)
                        select c;
