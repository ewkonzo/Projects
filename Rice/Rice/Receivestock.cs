    ...
    public partial class Receivestock : Form
    {
        ...
        private void loadata()
        {
            ...
            //{
                ...
                vendorBindingSource.DataSource = db.Vendors.Where(o=> o.Vendor_Posting_Group == "CREDITORS").ToList();
                item_Movement_HeaderBindingSource.DataSource = db.Item_Movement_Headers.Where(o => (o.Posted == 0 || string.IsNullOrEmpty(o.Posted.ToString())) && o.Movement_Type == (int)ItemMovementHeader.Movement_Type.Receive && o.Created_By == rice.user.Name).ToList();
        ...
        private void item_Movement_HeaderBindingSource_AddingNew(object sender, AddingNewEventArgs e)
        {
            try
            {
                ...
                sh.Movement_Type = (int)ItemMovementHeader.Movement_Type.Receive;
                ...
                //item_Movement_HeaderBindingSource.Add(sh);
        ...
        { try
            ...
            {
                if (supplierLookUpEdit.EditValue.ToString() == string.Empty)
                {
                    supplierLookUpEdit.Focus();
                    throw new Exception("Please select the supplier.");
                }
                if (invoiceTextBox.Text == string.Empty)
                {
                    invoiceTextBox.Focus();
                    throw new Exception("Please enter the invoice No:");
                }
                ...
                Task task = Task.Factory.StartNew(() =>
                  {
                          ...
                          if ((rice.setup.POS_Outlet == "20") ||(rice.setup.POS_Outlet == "22")||(rice.setup.POS_Outlet == "23")){
                      ...
                      {
                          for (int i = 1; i <= rice.setup.receive_copies; i++)
                          {
                              printTool.Print();
                          }
                      }}
