    ...
    public partial class Return : Form
    {
        ...
        private void loadata()
        {
            ...
            //        vendorBindingSource.DataSource = db.Vendors.ToArray();
                    ...
                    location_ToLookUpEdit.Properties.DataSource = rice.Location_Vendors.ToArray();
                    location_ToLookUpEdit.Properties.ValueMember = "code";
                    location_ToLookUpEdit.Properties.DisplayMember = "Name";

                    variantBindingSource.DataSource = db.Variants.ToList();
                    item_Movement_HeaderBindingSource.DataSource = db.Item_Movement_Headers.Where(o => (o.Posted == 0 || string.IsNullOrEmpty(o.Posted.ToString())) && o.Movement_Type == (int)ItemMovementHeader.Movement_Type.Return && o.Created_By == rice.user.Name).ToList();
        ...
        private void item_Movement_HeaderBindingSource_AddingNew(object sender, AddingNewEventArgs e)
        {
            try
            {
                ...
                sh.Movement_Type = (int)ItemMovementHeader.Movement_Type.Return;
        ...
        private void ribbonControl1_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            switch (e.Item.Name)
            {
                case "btnprint":
                    ...
                    Task task = Task.Factory.StartNew(() =>
            {
                Reports.Return s = new Reports.Return();
            ...
            if ((gridView3.PostEditor() && gridView3.UpdateCurrentRow()))
            {
                ...
                for (int j = 0; j < gridView3.RowCount; j++)
                {
                    ...
                    if (gridView3.IsDataRow(rowHandle))
                    {
                        ...
                        mov.Item = item.Item;
                        mov.Recid = DateTime.Now.AddMilliseconds(10).Ticks;
                        mov.Variant = item.Variant;
                        mov.User = header.Created_By;
