...
namespace AGENCY.Smsservice {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="DemosmsSoap", Namespace="http://tempuri.org/")]
    public partial class Demosms : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public Demosms() {
            this.Url = global::AGENCY.Properties.Settings.Default.AGENCY_Smsservice_Demosms;
        ...
        /// <remarks/>
        public void SendAsync(string message, string phone) {
            this.SendAsync(message, phone, null);
        }
        
        /// <remarks/>
        public void SendAsync(string message, string phone, object userState) {
            ...
            this.InvokeAsync("Send", new object[] {
                        message,
                        phone}, this.SendOperationCompleted, userState);
        }
        ...
        public void Getsms() {
            this.Invoke("Getsms", new object[0]);
        }
        ...
        private void OnGetsmsOperationCompleted(object arg) {
            if ((this.GetsmsCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.GetsmsCompleted(this, new System.ComponentModel.AsyncCompletedEventArgs(invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.81.0")]
    public delegate void GetsmsCompletedEventHandler(object sender, System.ComponentModel.AsyncCompletedEventArgs e);
}
