 ...
 * in a {@link agencyListActivity}.
 * <p/>
 * This activity is mostly just a 'shell' activity containing nothing
 * more than a {@link agencyDetailFragment}.
 */
public class agencyDetailActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(agencyDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(agencyDetailFragment.ARG_ITEM_ID));
            agencyDetailFragment fragment = new agencyDetailFragment();
            fragment.setArguments(arguments);
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.agency_detail_container, fragment)
                    .commit();
        }
    }
