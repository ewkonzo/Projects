...
public class ExchangeRate extends ActionBarActivity {
    Toolbar toolbar;
    GridView grid;
    ActionBar ab;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ab.setTitle(Html.fromHtml("<font style='color:black'>Set Exchange Rate</font>"));
    ...
    public void login(View v){
        ...
        if(pass.trim().isEmpty()){
            basic.showToast("Please enter rate");
        }else{
            edit.putInt("rate",Integer.parseInt(pass));
            edit.commit();
            basic.showAlert("You have set an exchange rate of (1 USD = "+pass+" KES ).You can alter it anytime");
        }
    }
