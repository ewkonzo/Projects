...
import elegance.hasoft.com.elegance.R;
...
public class Dialog extends android.app.Dialog{
	...
	public Dialog(Context context,String title, String message,String buttonCancelText) {
	...
	public void addCancelButton(String buttonCancelText){
		this.buttonCancelText = buttonCancelText;
        Toast.makeText(context,"canceltext"+buttonCancelText,Toast.LENGTH_LONG).show();
	}
