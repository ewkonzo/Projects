 ...
 * 					  >= 0 : success
 */
int smart_card_close(int nSlotIndex);
 ...
 * 						>= 0 : success
 */
int smart_card_power_on(int Handle, unsigned char* pATR, unsigned int* pATRBufferLength, SMART_CARD_SLOT_INFO* pSlotInfo);
/*
 ...
 * 					  >= 0 : success
 */
int smart_card_transmit(int Handle, unsigned char* pAPDU, unsigned int nAPDULength, unsigned char* pResponse, unsigned int *pResponseLength);
/*
 ...
 * 					  >= 0 : data length
 */
int smart_card_mc_read(int Handle, unsigned int nAreaType, unsigned char* pDataBuffer, unsigned int nDataLength, unsigned char cStartAddress);
 ...
 * 					  >= 0 : data length
 */
int smart_card_mc_write(int Handle, unsigned int nAreaType, unsigned char* pData, unsigned int nDataLength, unsigned char cStartAddress);
/*
 ...
 * 					  > 0 : success
 */
int smart_card_mc_verify_data(int Handle, unsigned char* pData, unsigned int nDataLength);
