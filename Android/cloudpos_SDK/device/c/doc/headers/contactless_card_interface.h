...
#define CONTACTLESS_CARD_TYPE_A_CPU				0x0000
#define CONTACTLESS_CARD_TYPE_B_CPU				0x0100
#define CONTACTLESS_CARD_TYPE_A_CLASSIC_MINI	0x0001
#define CONTACTLESS_CARD_TYPE_A_CLASSIC_1K		0x0002
#define CONTACTLESS_CARD_TYPE_A_CLASSIC_4K		0x0003
#define CONTACTLESS_CARD_TYPE_A_UL_64			0x0004
#define CONTACTLESS_CARD_TYPE_A_UL_192			0x0005
#define CONTACTLESS_CARD_TYPE_A_MP_2K_SL1		0x0006
#define CONTACTLESS_CARD_TYPE_A_MP_4K_SL1		0x0007
#define CONTACTLESS_CARD_TYPE_A_MP_2K_SL2		0x0008
#define CONTACTLESS_CARD_TYPE_A_MP_4K_SL2		0x0009
#define CONTACTLESS_CARD_UNKNOWN				0x00FF
...
/*
 * Touch the card after transaction. After final touch, if you want to send APDU again, you should attach it again
 * @param[in] : int nHandle : handle of this card reader
 * return value : 0 : no card
 *                >0 : has card
 * 				  < 0 , error code
 */
int contactless_card_final_touch_card(int nHandle);
/*
 ...
 * 				  < 0 , error code
 */
int contactless_card_send_control_command(int nHandle, unsigned int nCmdID, unsigned char* pCmdData, unsigned int nDataLength);
 ...
 *                < 0 : error code
 */
int contactless_card_mc_transfer(int nHandle, unsigned int nSectorIndex, unsigned int nBlockIndex);
/*
...
/*
 * disable hardware 
 * @param[in] : unsigned int nEable :  0 : disable
 * return value : >= 0 : success
 *                < 0 : error code
 */
int contactless_card_setEnable(unsigned int nEnable);
/*
 * @param[in] : int nHandle : handle of this card reader
