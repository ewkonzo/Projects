...
{
	int nCount = 0;
	JNINativeMethod* pMethods = customer_display_get_methods(&nCount);

	jint nResult = register_native_methods(env,	customer_display_get_class_name_allinpay(),	pMethods, nCount);
	//	+update by pengli
