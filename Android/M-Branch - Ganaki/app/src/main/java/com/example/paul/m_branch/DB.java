...
public class DB extends SQLiteOpenHelper {
    ...
    public static class t {
        ...
        public static final String Court_Bond="Court_Bond";
    ...
    static class v {
        ...
        public static final String Penalty = "Penalty";
        public static final String Daily_Welfare="Daily_Welfare";
        public static final String Daily_Shares="Daily_Shares";
        public static final String Daily_Court_Bond="Daily_Court_Bond";
        ...
        public static ContentValues values(vehicles vv) {
            ...
            contentValues.put(Arrears, vv.Arrears);
            contentValues.put(Penalty, vv.Penalty);
            contentValues.put(Code, vv.Code);
            contentValues.put(vehicle_type, vv.vehicle_type);
            contentValues.put(Daily_Welfare, vv.Daily_Welfare);
            contentValues.put(Daily_Shares, vv.Daily_Shares);
            contentValues.put(Daily_Court_Bond, vv.Daily_Court_Bond);
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(
                "create table " + v.vehicles_Table + "" +
                        "(" + v.Code + " text ," +
                        v.Vehicle_Number + " text primary key," +
                        v.vehicle_type + " text," +
                        v.Arrears + " float," +
                        v.Penalty + " float," +
                        v.Start_Date + " text," +
                        v.Daily_Contribution + " float," +
                        v.Daily_Court_Bond + " float," +
                        v.Daily_Shares + " float," +
                        v.Daily_Welfare + " float," +
                        v.Id_Number + " text)");
        db.execSQL(
    ...
    public boolean inserttrans(transaction f) {
        try {
            ...
            contentValues.put(t.Court_Bond, f.Court_Bond);
            contentValues.put(t.Shares, f.Shares);
            contentValues.put(t.Stage, f.Stage);
            contentValues.put(t.Welfare, f.Welfare);
            contentValues.put(t.Loan, f.Loan);
            contentValues.put(t.Savings, f.Savings);
            contentValues.put(t.Operation, f.Operation);
    ...
    public transaction gettrans(String Accountno) {
        ...
        if (res.getCount() > 0) {
            ...
            f.Shares = res.getDouble(res.getColumnIndex(t.Shares));
            f.Savings = res.getDouble(res.getColumnIndex(t.Savings));
            f.Court_Bond = res.getDouble(res.getColumnIndex(t.Court_Bond));
            f.Loan = res.getDouble(res.getColumnIndex(t.Loan));
            f.Operation = res.getDouble(res.getColumnIndex(t.Operation));
            f.Welfare = res.getDouble(res.getColumnIndex(t.Welfare));
            f.Stage = res.getDouble(res.getColumnIndex(t.Stage));
    ...
    public boolean insertmember(member f) {
        ...
        contentValues.put(m.Outstanding_Balance, f.Loan_Balances);
        contentValues.put(m.Repayment, f.Repayment);
        contentValues.put(m.Penalty, f.Outstanding_Penalty);
        contentValues.put(m.Operation, f.Operation_Cost);
    ...
    public ArrayList<member> getupdatedmember() {
        ...
        while (res.isAfterLast() == false) {
            ...
            f.Loan_Balances = res.getDouble(res.getColumnIndex(m.Outstanding_Balance));
            f.Repayment = res.getDouble(res.getColumnIndex(m.Repayment));
            f.Outstanding_Penalty = res.getDouble(res.getColumnIndex(m.Penalty));
            f.Operation_Cost = res.getDouble(res.getColumnIndex(m.Operation));
    ...
    public ArrayList<member> getmembers() {
        ...
        res.close();
        Log.i("Members",String.valueOf(ff.size()));
        return ff;
    }
...
//        }
    ...
    public ArrayList<vehicles> getvehicles() {
        ...
        while (res.isAfterLast() == false) {
            if (res.getString(res.getColumnIndex(v.Code))!=null) {
                ...
                f.Daily_Court_Bond = res.getDouble(res.getColumnIndex(v.Daily_Court_Bond));
                f.Daily_Shares = res.getDouble(res.getColumnIndex(v.Daily_Shares));
                f.Daily_Welfare = res.getDouble(res.getColumnIndex(v.Daily_Welfare));
        ...
        res.close();
        Log.i("Vehicles",String.valueOf(array_list.size()));
        return array_list;
    }
    ...
    public vehicles getvehicle(String c) {
        ...
        Cursor res = db.rawQuery("select * from " + v.vehicles_Table + " where " + v.Vehicle_Number + "= '" + c + "'", null);
