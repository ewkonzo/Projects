...
public class MLedgerReportsByTransTypeDepositPieChartFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(
				R.layout.mledger_reports_by_trans_type_pie_chart_dep_fragment,
				container, false);
		layout = (LinearLayout) rootView
				.findViewById(R.id.mledgerReportsByTransTypedepPiechart);
		return rootView;
	}
