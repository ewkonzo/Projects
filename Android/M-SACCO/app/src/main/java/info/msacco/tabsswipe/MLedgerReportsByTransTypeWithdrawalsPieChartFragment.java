...
public class MLedgerReportsByTransTypeWithdrawalsPieChartFragment extends
		Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(
				R.layout.mledger_reports_by_trans_type_pie_chart_withd_fragment,
				container, false);
		// Getting a reference to view group linear layout chart_container
		layout = (LinearLayout) rootView
				.findViewById(R.id.mledgerReportsByTransTypeWdPiechart);
		return rootView;
	}
	...
	private void openChart() {
		...
		for (int i = 0; i < newChartWithdrawalsArray.size(); i++) {
			...
			mRenderer.setChartTitle("Withdrawals");
