...
public class MLedgerReportsByTransTypeBarChart extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.mledger_reports_by_trans_type_bar_chart);
	...
	private void openChart() {
		...
		try {
			...
			multiRenderer.setBarSpacing(20);
			multiRenderer.setBarWidth(30);
			multiRenderer.setLegendTextSize(18);
			multiRenderer.setChartTitle("Reports by account type.");
			multiRenderer.setPanEnabled(true, false);
			multiRenderer
					.setChartTitle("Deposits and Withdrals by transaction type");
