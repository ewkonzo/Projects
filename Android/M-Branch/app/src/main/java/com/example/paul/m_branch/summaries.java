...
import static com.example.paul.m_branch.summaries.printer.printerin;
...
//    }
    public static class printer {
        ...
        public void printcollection(Bitmap logo, List<transaction> t) {
            try {
                String head;
                head  = "    HOMABAY COUNTY WOMEN SACCO   \n";
                head += "      P.O Box 390 - 40300   \n";
                head += "           HOMA BAY   \n";
                head += "       Cell No. 0707587133  \n";
                head += "   Email:info@hbcwomensacco.com  \n\n";

               // print_image(logo);
                head += "         CASH RECIEPT           \n";
                String data = "";
                data =  "--------------------------------\n\n";
                data += "Trans. No:   " + t.get(0).OTTN + "\n";
                data += "Member No:  " + t.get(0).Account_No + "\n";
                data += "Member Name:" + t.get(0).Account_Name + "\n";
                data += "Trans. Date: " + t.get(0).Date + "\n";
                data += "Trans. Time: " + t.get(0).Time + "\n";
                data +=  "--------------------------------\n\n";
                ...
                data += "Served by:  " + login.CurrentAgent.Name + "\n\n\n\n\n";
                try {
                    Thread.sleep(1000);
        ...
        int mWidth , mHeight; String mStatus;
