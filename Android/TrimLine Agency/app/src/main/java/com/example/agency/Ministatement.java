            ...
            public void onClick(View v) {
                ...
                if (nationalID.equals("") || nationalID == null) {
                    ...
                    if (internetConnectionStatus) {
                        ...
                        misc.tost(Ministatement.this, getString(R.string.nointernet));
                    }
    ...
    private class GetAccounts extends AsyncTask<Transaction, Void, Transaction> {
        ...
        protected Transaction doInBackground(Transaction... params) {
            ...
            try {
                ...
                result = JsonParser.SendHttpPost(Ministatement.this, "Accounts", result,
                        "data");
        ...
        private void SelectAcc(Member paramMember) {
            AlertDialog.Builder localBuilder = new AlertDialog.Builder(Ministatement.this);
            localBuilder.setTitle("Accounts");
            localBuilder.setMessage("Select Account to use");
            ListView localListView = new ListView(Ministatement.this);
            localListView.setChoiceMode(1);
            localListView.setAdapter(new BindAccounts(Ministatement.this, paramMember.accounts));
    ...
    private class Transsync extends AsyncTask<Transaction, Void, Transaction> {
        ...
        protected Transaction doInBackground(Transaction... params) {
            ...
            try {
                Gson g = new Gson();
                result = g.toJson(this.t);
                result = JsonParser.SendHttpPost(Ministatement.this, "Transactions", result,
                        "data");
                Type localType = new TypeToken<Transaction>() {
                }.getType();
                results = new Gson().fromJson(result, localType);
        ...
        protected void onPostExecute(Transaction res) {
            ...
            switch (trans.status) {
                ...
                case Successful:
                    try{
                        DB db = new DB(Ministatement. this);
