  ...
  extends BaseAdapter
{
  ...
  public View getView(final int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      this.holder.maxloan.setText(String.valueOf (this.DataCollection.get(paramInt).Max_Loan_Amount));
      this.holder.Type.setText(this.DataCollection.get(paramInt).Product_Description);
...
//          BindLoans.access$102(BindLoans.this, (RadioButton)paramAnonymousView);
          BindLoanproducts.outdata = BindLoanproducts.this.DataCollection.get(paramInt);
        }
      });
