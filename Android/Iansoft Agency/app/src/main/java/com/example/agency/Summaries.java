...
import static com.example.agency.AgencyListActivity.printerDevice;
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            if (printerDevice.queryStatus() == printerDevice.STATUS_OUT_OF_PAPER) {
                               mHandler.obtainMessage(Constants.PRINTER_NO_PAPER);
                               return;
                            }
                            Format format = new Format();
                            format.setParameter("size", "medium");
                            format.setParameter("align", "center");
                            printerDevice.printText(format, head);
//
...
//                            printerDevice.printText(format, "medium，POS sign purchase order\n");
                            ...
                            format.clear();
                            format.setParameter("size", "medium");
                            printerDevice.printText(format, finalData);
