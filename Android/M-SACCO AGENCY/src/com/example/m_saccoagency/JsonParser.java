...
public class JsonParser {
	...
	static String json = "";
	public static String WEBSERVICE_URL = "http://192.168.43.72:35051/Agency.asmx/";
	...
	public static String SendHttpPost(Activity paramActivity,
		...
		// Creating HTTP Post
		HttpPost httpPost = new HttpPost(WEBSERVICE_URL + MethodName);
