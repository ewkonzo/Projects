...
public class MemberRegistration extends Activity {
	...
	private static final String SOAP_ACTION = "http://tempuri.org/MemberRegistration";
	private static final String OPERATION = "MemberRegistration";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		BtnCancel.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent(MemberRegistration.this,
		...
		BtnConfirm.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(AccName.equals("")|| AccName == null){
					...
					new RegisterMember().execute(new String[] { AccName,NationaID,TelNo,Society,MemberNo,
	...
	private class RegisterMember extends AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String res) {
			try {
				...
				if (res.equalsIgnoreCase("true")) {
					DialogBoxWithRefresh("Member Registration", "Successful!");
