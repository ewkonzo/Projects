...
public class MLedgerReportsByTimePieChart extends Activity
		implements
		MLedgerReportsByTimeDepositPieChartFragment.depositReportsDataListener,
		MLedgerReportsByTimeWithdrawalsPieChartFragment.withdrawalReportsDataListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		MLedgerReportsByTimeDepositPieChartFragment depfragment = new MLedgerReportsByTimeDepositPieChartFragment();
			...
			public boolean onNavigationItemSelected(int itemPosition,
				...
				case 0:
					 if (totals(depositsArray) < 0.1) {
						  ...
						  fragmentTransaction.commit(); } 
					 else { MLedgerReportsByTimeDepositPieChartFragment depfragment = new
							  MLedgerReportsByTimeDepositPieChartFragment();
							  fragmentTransaction.replace(R.id.container, depfragment);
							  fragmentTransaction.commit();
					}
					return true;
				case 1:
					if (totals(withdrawalArray) < 0.1) {
						...
						fragmentTransaction.commit();
						  ...
						  MLedgerReportsByTimeWithdrawalsPieChartFragment withdfragment = new
								  MLedgerReportsByTimeWithdrawalsPieChartFragment();
