...
public class MLedgerReportsByAccTypePieChart extends Activity
		implements
		MLedgerReportsByAccTypeDepositPieChartFragment.depositReportsDataListener,
		MLedgerReportsByAccTypeWithdrawalsPieChartFragment.withdrawalReportsDataListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.mledger_reports_by_acc_type_pie_chart);

		// Declare intent to get the data send from
		// MledgerReportsByAccTypeActivity.
		...
		MLedgerReportsByAccTypeDepositPieChartFragment depfragment = new MLedgerReportsByAccTypeDepositPieChartFragment();
			...
			public boolean onNavigationItemSelected(int itemPosition,
				...
				case 1:
					if (totals(withdrawalArray) < 0.1) {
						...
						MLedgerReportsByAccTypeWithdrawalsPieChartFragment withdfragment = new MLedgerReportsByAccTypeWithdrawalsPieChartFragment();
	...
	// @Override
	// public boolean onNavigationItemSelected(int itempos, long arg1) {

	/*
	 * android.app.FragmentManager fragmentManager = getFragmentManager();
	 * android.app.FragmentTransaction fragmentTransaction = fragmentManager
	 * .beginTransaction(); switch (itempos) { case 0: if (totals(depositsArray)
	 * < 0.1) { noTransactionFoundFragment fragment = new
	 * noTransactionFoundFragment(); fragmentTransaction.replace(R.id.container,
	 * fragment); fragmentTransaction.commit(); } else {
	 * MLedgerReportsByAccTypeDepositPieChartFragment depfragment = new
	 * MLedgerReportsByAccTypeDepositPieChartFragment();
	 * fragmentTransaction.replace(R.id.container, depfragment);
	 * fragmentTransaction.commit(); } return true; case 1: if
	 * (totals(depositsArray) < 0.1) { noTransactionFoundFragment fragment = new
	 * noTransactionFoundFragment(); fragmentTransaction.replace(R.id.container,
	 * fragment); fragmentTransaction.commit(); } else {
	 * MLedgerReportsByAccTypeWithdrawalsPieChartFragment withdfragment = new
	 * MLedgerReportsByAccTypeWithdrawalsPieChartFragment();
	 * fragmentTransaction.replace(R.id.container, withdfragment);
	 * fragmentTransaction.commit(); } return true; default:
	 * MLedgerReportsByAccTypeDepositPieChartFragment depfragment = new
	 * MLedgerReportsByAccTypeDepositPieChartFragment();
	 * fragmentTransaction.replace(R.id.container, depfragment);
	 * fragmentTransaction.commit(); return false; } }
	 */
}
