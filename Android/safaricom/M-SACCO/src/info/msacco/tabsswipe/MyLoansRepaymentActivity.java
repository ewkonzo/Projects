...
public class MyLoansRepaymentActivity extends Activity implements
	...
	public void onCreate(Bundle savedInstanceState) 
	{
		...
		setContentView(R.layout.my_loans_repayment_fragment);
		...
		spinner = (Spinner) findViewById(R.id.myLnsRepaymentSpinner);
		accFromspinner = (Spinner) findViewById(R.id.myLnsRepaymentAccountSpinner);

		repaymentAmt = (EditText) findViewById(R.id.myLnsRepaymentAmtEdtxt);
		onRepaymentBtnClicked = (Button) findViewById(R.id.myLnsRepaymentSendBtn);
		...
		protected void onPostExecute(SoapObject res) {
			try {
				...
				if (ex.getMessage() == null)
					...
					Toast.makeText(MyLoansRepaymentActivity.this,
			...
			try {
				...
				if (envelope.bodyIn instanceof SoapFault) {
					...
					if (String.valueOf(resultsRequestSOAP.getProperty(n - 1))
						...
						result = "Request not sent.Could not connect to server";
						// alert(result);
					}
					return result;
				}
	...
	public void alert(String text) {
		Toast.makeText(MyLoansRepaymentActivity.this.getApplicationContext(),
	...
	{
		SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(MyLoansRepaymentActivity.this);
