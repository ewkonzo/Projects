...
namespace Collection.Vehicles {
    ...
    public partial class Vehicles_Service : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public Vehicles Read(string Vehicle_Number, string Code) {
        ...
        /// <remarks/>
        public void ReadAsync(string Vehicle_Number, string Code) {
            this.ReadAsync(Vehicle_Number, Code, null);
        }
        
        /// <remarks/>
        public void ReadAsync(string Vehicle_Number, string Code, object userState) {
